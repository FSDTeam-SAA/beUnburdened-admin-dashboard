...
function BlogManagement() {
    ...
    const cu = (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSession"])();
    const accessToken = ((_cu_data = cu.data) === null || _cu_data === void 0 ? void 0 : (_cu_data_user = _cu_data.user) === null || _cu_data_user === void 0 ? void 0 : _cu_data_user.accessToken) || '';
    ...
    const handleAddBlog = (accessToken)=>{
        router.push('/admin-dashboard/blog-management/add');
    };
    const handleEditBlog = (accessToken, blog)=>{
...
_s(BlogManagement, "w6V7RPHVHCpVEXoC23G1s94O+7s=", false, function() {
    return [
