...
function useGetOrders() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            const res = await axiosInstance.get(`${("TURBOPACK compile-time value", "http://localhost:5000/api/v1")}/order`, {
                headers: token ? {
...
function useGetActiveProducts() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            const res = await axiosInstance.get(`${("TURBOPACK compile-time value", "http://localhost:5000/api/v1")}/product/seller/active-products`, {
                headers: token ? {
                    Authorization: `Bearer ${token}`
                } : {}
            });
...
function useGetPendingProducts() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            const res = await axiosInstance.get(`${("TURBOPACK compile-time value", "http://localhost:5000/api/v1")}/product/seller/pending-products`, {
                headers: token ? {
                    Authorization: `Bearer ${token}`
                } : {}
            });
...
function useDeleteProduct() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: async (productId)=>{
            await axiosInstance.delete(`${("TURBOPACK compile-time value", "http://localhost:5000/api/v1")}/product/${productId}`, {
                headers: token ? {
                    Authorization: `Bearer ${token}`
                } : {}
            });
...
function useUpdateProduct(options) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: async (payload)=>{
            ...
            await axiosInstance.patch(`${("TURBOPACK compile-time value", "http://localhost:5000/api/v1")}/product/${productId}`, data, {
                headers: token ? {
                    Authorization: `Bearer ${token}`
                } : {}
            });
...
function useGetSingleProductById(productId) {
    const { data, refetch, isLoading, isError, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            ...
            const res = await axiosInstance.get(`${("TURBOPACK compile-time value", "http://localhost:5000/api/v1")}/product/${productId}`);
            return res.data;
        },
        enabled: !!productId
    });
...
const useGetSellerSales = ()=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            const res = await axiosInstance.get(`${("TURBOPACK compile-time value", "http://localhost:5000/api/v1")}/order/seller/sales`, {
                headers: token ? {
                    Authorization: `Bearer ${token}`
                } : {}
            });
...
const useGetUserProfile = ()=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            const res = await axiosInstance.get(`${("TURBOPACK compile-time value", "http://localhost:5000/api/v1")}/user/me`, {
                headers: token ? {
                    Authorization: `Bearer ${token}`
                } : {}
            });
...
const useUpdateUserProfile = ()=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: async (data)=>{
            const res = await axiosInstance.put(`${("TURBOPACK compile-time value", "http://localhost:5000/api/v1")}/user/me`, data, {
                headers: token ? {
                    Authorization: `Bearer ${token}`
                } : {}
            });
...
const useUploadAvatar = ()=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: async (file)=>{
            ...
            const res = await axiosInstance.patch(`${("TURBOPACK compile-time value", "http://localhost:5000/api/v1")}/user/upload-avatar`, formData, {
                headers: {
...
const useChangePassword = ()=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: async (data)=>{
            const res = await axiosInstance.post(`${("TURBOPACK compile-time value", "http://localhost:5000/api/v1")}/auth/change-password`, data, {
                headers: token ? {
                    Authorization: `Bearer ${token}`
                } : {}
            });
...
const useGetDashboardSummary = ()=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            const res = await axiosInstance.get(`${("TURBOPACK compile-time value", "http://localhost:5000/api/v1")}/dashboard/seller/dashboard-summary`, {
                headers: token ? {
                    Authorization: `Bearer ${token}`
                } : {}
            });
...
const useGetRevenueReport = (period)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            const res = await axiosInstance.get(`${("TURBOPACK compile-time value", "http://localhost:5000/api/v1")}/dashboard/seller/revenue-report?filter=${period}`, {
                headers: token ? {
                    Authorization: `Bearer ${token}`
                } : {}
            });
...
const useGetColors = (page = 1, limit = 50)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            const res = await axiosInstance.get(`${("TURBOPACK compile-time value", "http://localhost:5000/api/v1")}/color?page=${page}&limit=${limit}`, {
                headers: token ? {
                    Authorization: `Bearer ${token}`
                } : {}
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7f1f31e6._.js.map