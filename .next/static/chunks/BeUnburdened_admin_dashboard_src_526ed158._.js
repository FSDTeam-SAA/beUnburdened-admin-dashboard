    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useGetBlogs.useQuery": async ()=>{
                const res = await fetch("".concat(API_BASE_URL, "/blogs?page=").concat(page, "&limit=").concat(limit), {
                    credentials: 'include',
                    headers: {
                        ...getAuthHeaders()
                    }
...
function AddBlogPage() {
    ...
    const { mutate: addBlog, isPending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$BeUnburdened_admin_dashboard$2f$src$2f$lib$2f$blogApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAddBlog"])();
...
_s(AddBlogPage, "CeakhReQL8owHvRZngrUkHYDLmA=", false, function() {
    return [
...
//# sourceMappingURL=BeUnburdened_admin_dashboard_src_526ed158._.js.map